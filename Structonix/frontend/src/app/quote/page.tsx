        ...
        <div className="min-h-screen bg-gray-50 pt-32 pb-24">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    <span className="text-primary font-bold tracking-widest uppercase text-sm mb-4 block">Request an Estimation</span>
                    <h1 className="text-4xl md:text-5xl font-bold text-dark-navy mb-6">Start Your Project Today</h1>
