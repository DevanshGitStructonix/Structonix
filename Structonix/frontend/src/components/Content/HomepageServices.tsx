                    ...
                    {services.map((service) => (
                        ...
                        >
                            ...
                            <div className="absolute bottom-0 left-0 w-full bg-dark-navy p-8 transition-colors duration-300 group-hover:bg-primary z-20">
                                ...
                                {/* Description Area - Hidden by default, animating in could be tricky without fixed height, 
                                    but design implies it might just be there or simple text. 
                                    Use simple opacity transition for now based on card height.
                                */}
